...
const getFormaPagamentoById = async (req, res) => {
  try {
    ...
    const result = await pool
      ...
      .query('SELECT idformapagamento, nome, gerartitulofatura, gerartitulovenda, debito, credito, empresa FROM formapagamento WHERE idformapagamento = @idformapagamento');
